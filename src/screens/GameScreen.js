...
const nodes = [
  ...
  },
  {
    ...
    x: 534,
    y: 1009,
    connectedTo: ["southern_pass", "final_road"],
    title: "Deep South",
    type: "event",
  ...
  },
  {
    ...
    x: 555,
    y: 410,
    connectedTo: ["central_crossing", "north_fork", "east_split"],
    title: "East Gate",
    type: "event",
  ...
  },
  {
    ...
    x: 600,
    y: 260,
    connectedTo: ["east_gate", "north_peak", "east_split"],
    title: "North Fork",
    type: "event",
  ...
  },
  {
    ...
    x: 725,
    y: 300,
    connectedTo: ["north_fork", "north_peak", "east_lake", "ruin_path"],
    title: "East Split",
    type: "event",
  ...
  },
  {
    ...
    x: 783,
    y: 650,
    connectedTo: ["east_split", "east_lake", "eastern_ruins", "far_east"],
    title: "Ruin Path",
    type: "event",
  ...
  },
  {
    ...
    x: 625,
    y: 735,
    connectedTo: ["southern_pass", "ruin_path", "far_east"],
    title: "Eastern Ruins",
    type: "reward",
  ...
  },
  {
    ...
    x: 870,
    y: 815,
    connectedTo: ["ruin_path", "eastern_ruins", "east_outpost"],
    title: "Far East",
    type: "shop",
